...
extern const uint8_t critical_html_start[] asm("_binary_critical_html_start");
extern const uint8_t critical_html_end[] asm("_binary_critical_html_end");
...
static esp_err_t get_i2c(httpd_req_t *req)
{
...
static esp_err_t get_ssd1306(httpd_req_t *req)
{
    return send_embedded_file(req, ssd1306_html_start, ssd1306_html_end, "text/html");
}

static esp_err_t get_ota(httpd_req_t *req)
{
    return send_embedded_file(req, ota_html_start, ota_html_end, "text/html");
}

static esp_err_t get_predictions(httpd_req_t *req)
{
...
static esp_err_t get_critical(httpd_req_t *req)
{
    return send_embedded_file(req,
                              critical_html_start,
                              critical_html_end,
...
esp_err_t ws_register_static(httpd_handle_t server)
{
    ...
    httpd_uri_t uri_critical = {.uri = "/critical", .method = HTTP_GET, .handler = get_critical};
    ...
    httpd_register_uri_handler(server, &uri_critical);
